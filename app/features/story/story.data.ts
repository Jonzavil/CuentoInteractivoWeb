...
export const STORY_SCENES = [
  ...
  },
  {
    ...
    title: "Guardianes de Galápagos",
    videoSrc: "/assets/ANIMACIONES/ULT 05.mp4",
    toneSrc: "/assets/tonos/insignias.mp3",
    copyBlocks: [{
      text: "¡Felicidades! Conseguiste una insignia de cada región\ndel Ecuador y completaste todas las misiones.",
      top: 6,
      left: 23,
      width: 54,
      align: "center",
  ...
  {
    id: "guardianes-de-la-fauna",
    title: "Guardianes de la Fauna",
    backgroundImageSrc: "/assets/ANIMACIONES/ULT 06.png",
    overlayImageSrc: "/assets/ANIMACIONES/TITULO.png",
    copyBlocks: [{
      text: "Ahora tú también eres parte de los Guardianes de la Fauna. Recuerda: conocer a\nnuestros animales es el primer paso para protegerlos. ¡La misión continúa contigo!",
      top: 61,
      left: 10,
      width: 80,
      align: "center",
