...
export const STORY_SCENES = [
  ...
  },
  {
    ...
    copyBlocks: [{
      text: "Lola y Mario entraron a la biblioteca y quedaron frente a frente. Habían buscado por todas partes, pero no encontraban ni un solo libro que llamara su atención.",
      top: 71.8,
      left: 39.6,
      width: 29.5,
      align: "center",
